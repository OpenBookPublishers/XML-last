...
for f in os.listdir(XML_DIR):
    ...
    if os.path.isfile(file):
        ...
        for tei in teilist:
            ...
            if re.search(r'XML-edition\/', base) is not None:
        ...
        for note in notes:
            ...
            if fnote is not None:
                if re.search('\t', fnote) is not None:
